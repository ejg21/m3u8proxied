...
export const domainTemplates: DomainTemplate[] = [
  // Padorupado.ru
   ...
   {
     pattern: /valiw\.hakunaymatata\.com$/i,
     headers: {
       'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0',
       'accept': '*/*',
       'accept-language': 'en-US,en;q=0.5',
   ...
   {
     pattern: /hurricane\.vidlvod\.store$/i,
     headers: {
       'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0',
       'accept': '*/*',
       'accept-language': 'en-US,en;q=0.5',
...

  {
   ...
   {
     pattern: /svz\.smartstreamhosting\.site$/i,
     headers: {
       'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0',
       'accept': '*/*',
       'accept-language': 'en-US,en;q=0.5',
  ...
  // mistyvalley31.live
  {
   ...
   
   {
    ...
    // shadowlandschronicles - blank for now since no header might work
  ...
  // twitch CDN
  {
   ...
   {
     pattern: /bcdnw\.hakunaymatata\.com$/i,
     headers: {
       'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0',
       'accept': '*/*',
       'accept-language': 'en-US,en;q=0.5',
  ...
  // twitch CDN
  {
   ...
   {
     pattern: /oca\.flutch09\.workers\.dev$/i,
     headers: {
       'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0',
       'accept': '*/*',
       'accept-language': 'en-US,en;q=0.5',
   ...
   {
        pattern: /oca\.flutch05\.workers\.dev$/i,
        headers: {
          'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0',
          'accept': '*/*',
          'accept-language': 'en-US,en;q=0.5',
